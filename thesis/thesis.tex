    ...
    \section{Deep Neural Networks}
        ...
        \subsection{Training}
            ...
            \subsubsection{Gradient Descent}
               ...
               and non-linear transformations between matrices, starting from the first to the last of the layers in what is called a \textit{forward pass}. As it turns out, to attempt to solve \ref{erm} we need to follow the exact
               opposite path. Assume infact 
