    ...
    \section{Deep Neural Networks}
        ...
        \subsection{Training}
            ...
            \subsubsection{Gradient Descent}
               ...
               what does it mean to be able to compute partial derivatives of the loss ? it means be able to understand where and how 
               the loss decreases and thus we can exploit such information to find optimal weights values, this is 
               the idea behind the gradient descent algorithm.
