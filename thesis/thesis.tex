...
\chapter{Conclusions and Future Works}
        ...
        Our initial hyphotesis on the potential of Gaussian kernel-based activation functions in improving
        adversarial training was only marginally validated by the experiments we made. Even though
        ...
        or even the regularization of the mixing coefficients, might have led to stronger results, we conclude (or believe?) that the main reason behind the 
