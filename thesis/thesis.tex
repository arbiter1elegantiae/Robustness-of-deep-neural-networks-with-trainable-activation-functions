...
\chapter{Fundamentals}
    ...
    \section{Deep Neural Networks}
        ...
        \subsection{Definition}
            ...
            The resulting model is the mathematical composition of the layers, thus if we let $ L $ be the number of layers, $ z_0 = \mathbf{x} $ and $ z_l = \sigma_l\left(z_{l-1}\right) = \sigma_l\left(W_{l}x + b_l\right) $
            we write a $L$-layered $f_{\mathbf{W}, \mathbf{b}}$:
            \[
                f_{\mathbf{W}, \mathbf{b}} = \sigma_{L}\left(\sigma_{L-1}\left(\ldots\left(\sigma_{1}\left(W_{1}z_{0} +b_1\right)\right)\right)\right)
            \]
            . This general but still basic form of Neural Network is known as \textit{Feed Forward Neural Network} 
        \subsection{Training}
