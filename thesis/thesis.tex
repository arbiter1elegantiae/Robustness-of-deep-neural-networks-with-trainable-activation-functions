...
\chapter{Introduction}
    ...
    \section{Intriguing Properties of Neural Networks}
        ...
        it is sufficient for an \textit{adversary} to add a small amount of targeted noise on an input in order to induce the model to predict, with high confidence,
        a wrong class. Despite the fact that such \textit{attacks} are relevant for many different domains, it is typical to introduce the problem with concrete examples dealing with images.
        Indeed, in the framework of image classification, perturbations have a nice interpretation in terms of norms and the problem itself can be appreciated visually.
