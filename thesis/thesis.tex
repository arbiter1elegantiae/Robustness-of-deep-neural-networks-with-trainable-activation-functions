...
\chapter{Introduction}
    ...
    \section{Intriguing Properties of Neural Networks}
        ...
        Thus, making them all prone to suffer from some kind adversarial attack, if no defense technique is explicitly implemented.
        ...
        seem to be only one of the many syntoms of the discrepancy between the way human and intelligent systems currently learn.
