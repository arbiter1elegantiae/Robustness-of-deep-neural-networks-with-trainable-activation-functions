...
\chapter{Solution Approach}
    ...
    \section{KAFs May Be Good Candidates}
        ...
        seem to be smaller in comparison to the distance (between distributions) that we see in the last layer for k-WTA and ReLU. Having said that, it is stil plausible 
        ...
        to repeat the experiment, this time considering the distribution for the whole layers, that is, the average mean for the activations of a given 
       ...
       \newline
        ...
        \end{figure}
        \newline
        and so on. The Kafnet almost always results in smaller distances norms.
