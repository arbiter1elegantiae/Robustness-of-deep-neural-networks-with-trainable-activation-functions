...
Swish smooth activation functions.
    ...
    \section{VGG Inspired Architectures Results}
        ...
        even with this last attempt, the model scores 77.54\% and 46.2\% in accuracy and robustness respectively, positioning these last "moving" KAFs (that we call KAF\_Free), 
        ...
        \begin{figure}[h!]
            ...
            \label{fig:accrob1}
        \end{figure}
        Code and in-depth visualizations on KAF's shapes evolutions are located in \textit{fbf\_training\_kafvgg.ipynb}
        \begin{table}
            \centering
