...
\chapter{Introduction}
    ...
    \section{Intriguing Properties of Neural Networks}
        ...
        building a more human-aligned models. Any claim about state-of-the-art classifiers that have surpassed "human performances" is indeed far from being true, if we look at the task through the lens of adversarial examples.
        ...
        Furthermore, things get even more complicated when we try to scale up to larger, more realistic models, since it generally becomes extremely expensive to train robust models (Ref. Free adversarial training).
        ...
        % Abbiamo quindi capito per quale motivo molta ricerca e' stata indirizzata verso lo studio degli esempi avversari. Tuttavia qual'e lo stato attuale?
        % Brevemente, non siamo ancora in grado di avere modelli performanti e che siano anche resistenti, su cifar 10 la rete piu robusta attualmente sviluppata ha un accuracy di 60 percento su perturbazioni 
        % inoltre, scalare a dataset maggiori eg imagenet richiede l utilizzo di molte risorse
        % per questo motivo l adversarial robustness e tutt ora un aria di ricerca molto attiva
