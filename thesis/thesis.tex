...
Swish smooth activation functions.
    ...
    \section{VGG Inspired Architectures Results}
        ...
        on the test set. Lastly, PGD is performed and the overall accuracy of our network against the perturbed images is 45.61\%. Therefore, we were able to
        ...
        \begin{figure}[h!]
            ...
            \label{fig:pgditers}
        \end{figure}
        For this reason we are going to consider only PGD with 50 steps attacks for the evaluations.
